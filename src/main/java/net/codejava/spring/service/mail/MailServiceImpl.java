...
public class MailServiceImpl  implements MailService{
    ...
    static final String FROM = "order@mycakenbake.com";
    ...
    static final String SMTP_USERNAME = "AKIAJLXZNRMPYV26WJSQ";
    
    // Replace smtp_password with your Amazon SES SMTP password.
    static final String SMTP_PASSWORD = "Ah/tkw8BFgBMPy3lhtrir2IeMBjLOKfRmlG02IvW+rMD";
	...
	public boolean sendMail(String from, String to, String body, String subject,String replyTo) throws Exception {
        ...
        Address [] addresses_sending =  { new InternetAddress(to.split(",")[0]), new InternetAddress(to.split(",")[1])};
        msg.setRecipients(Message.RecipientType.TO, addresses_sending);
        }else{
